...
const {saveEmployeeRecords,getEmployeeRecords,deleteAllEmployeeRecords} = require("./controllers/employee");
...
const mongo_uri = 'mongodb+srv://rahul:sFIvsLs9KX5yoovd@cluster0.bnext.mongodb.net/csv_upload?retryWrites=true&w=majority';
...
app.get('/api/get-employees-data/:page',withAuth,getEmployeeRecords,responseSender);
