 ...
 import { API_ERROR, DELETE_EMPLOYEES_ACTION, DELETE_SUCCESS_EMPLOYEES_ACTION, GET_EMPLOYEES_ACTION, GET_EMPLOYEES_SUCCESS_ACTION, LOGIN_ACTION,LOGIN_SUCCESS_ACTION,SAVE_EMPLOYEES_ACTION,SAVE_EMPLOYEES_SUCCESS_ACTION,SIGNUP_ACTION, SIGNUP_SUCCESS_ACTION, UNAUTHORIZED_ACTION } from './constants';
 ...
 export function* userLogin(action) {   
   try {
    ...
    const response = yield call(request, requestURL,{method:"POST",body:payload});
